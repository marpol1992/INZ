...
public class realtime extends ActionBarActivity {
    ...
    public double graph2LastXValue = 0.1d;
    double plus_minus = 1;
    long czas = 1;
    ...
    public void onResume() {
        ...
        nTimer2 = new Runnable() {
            ...
            public void run() {
                        ...
                        graph2LastXValue += 1d;
                        plus_minus+=1;
                        nSeries2.appendData(new DataPoint(graph2LastXValue, plus_minus), true, 1000);
                        processing_Frame.flaga = false;
                        if(graph2LastXValue >=50) {
                            graph2LastXValue = 0;
                            plus_minus = 0;
